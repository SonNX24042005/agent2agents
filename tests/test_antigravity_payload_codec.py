import unittest
from agent2agents.codecs.antigravity_payload_codec import AntigravityPayloadCodec


class AntigravityPayloadCodecTests(unittest.TestCase):
    def test_encode_and_decode_varint_round_trip(self):
        c = AntigravityPayloadCodec
